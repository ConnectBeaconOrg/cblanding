        ...
        <Stack direction={{ xs: "column", md: "row" }} spacing={4} alignItems="center">
          ...
          <Stack spacing={2}>
            ...
            <Typography color="text.secondary">
              Connect Beacon delivers modern connectivity and SaaS solutions tailored to dynamic enterprise environments. Our offerings include LTE/5G infrastructure, WAN optimization, secure access (SASE/Zero Trust), and full-stack SaaS development backed by robust observability and AI-driven analytics.
            </Typography>
          </Stack>
        </Stack>
      </Container>
